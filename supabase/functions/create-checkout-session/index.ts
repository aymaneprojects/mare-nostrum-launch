      ...
      line_items: [{
        price_data: {
          ...
          product_data: {
            ...
            // txcd_20030000 = services digitaux / SaaS — Stripe applique le bon taux TVA
            tax_code: "txcd_20030000",
          },
          unit_amount: amount,
          // inclusive = prix affiché TTC, Stripe extrait la TVA sans majorer
          tax_behavior: isFrance ? "inclusive" : "exclusive",
          recurring: { interval },
        },
        quantity: 1,
      }],
      // Calcul automatique TVA selon localisation du client (France = 20%)
      automatic_tax: { enabled: isFrance },
      // Permet aux clients B2B de saisir leur n° TVA intracommunautaire
