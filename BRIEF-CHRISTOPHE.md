...
- **Le slug, c'est le prénom** : la fiche est `marenostrum.tech/equipe/alexis`, `/equipe/aymane`… C'est cette adresse que les QR codes encodent. Deux prénoms identiques → ajouter le nom au second (`/equipe/alexis-dupont`).
